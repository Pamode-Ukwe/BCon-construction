...
const ContactUs = () => {
  return (
    <section id="contact-us" className="md:px-32 sm:px16 px-4 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16 py-4">
            <img src={contactPic} alt="" className="sm:w-full w-3/4 sm:mx-0 mx-auto"/>
            <div className="grid lg:grid-cols-2 text-center gap-6 sm:w-full w-3/5">
                <div className="grid border border-transparent xs:border-gray-200 xs:shadow-lg hover:border-orange-300 hover:cursor-pointer hover:shadow-lg">
                ...
                <div className="grid border border-transparent xs:border-gray-200 xs:shadow-lg hover:border-orange-300 hover:cursor-pointer hover:shadow-lg">
                    ...
                    <div className="text-gray-600 text-sm flex justify-between gap-2 lg:px-18 px-44 lg:pt-0 pt-2  lg:pb-0 pb-8">
